...
*/
  ...
  class osC_Addshoppers_Admin {
    var $_group = 'addshoppers',
        $_status = false,
        $_active = false;
...
// class methods
    function load() {
      ...
      if (defined('MODULE_DEFAULT_ADDSHOPPERS') && !osc_empty(MODULE_DEFAULT_ADDSHOPPERS) && file_exists('includes/modules/addshoppers/' . MODULE_DEFAULT_ADDSHOPPERS . '.php')) {
        $osC_Language->loadIniFile('modules/addshoppers/' . MODULE_DEFAULT_ADDSHOPPERS . '.php');
        include('includes/modules/addshoppers/' . MODULE_DEFAULT_ADDSHOPPERS . '.php');
        $module = 'osC_Addshoppers_' . MODULE_DEFAULT_ADDSHOPPERS;
        return new $module();
      } else {
        return new osC_Addshoppers_Admin();
      }
    }
    ...
    function install() {
      ...
      if (defined('MODULE_DEFAULT_ADDSHOPPERS')) {
        include('includes/modules/addshoppers/' . MODULE_DEFAULT_ADDSHOPPERS . '.php');
        $module = 'osC_Addshoppers_' . MODULE_DEFAULT_ADDSHOPPERS;
        $module = new module();
        $module->remove();
      ...
      $Qcfg->bindValue(':configuration_title', 'Default Addshoppers Module');
      $Qcfg->bindValue(':configuration_key', 'MODULE_DEFAULT_ADDSHOPPERS');
      $Qcfg->bindValue(':configuration_value', $this->_code);
      $Qcfg->bindvalue(':configuration_description', 'Default Addshoppers module.');
...
*/
    ...
    function remove() {
      ...
      $Qdel->bindValue(':configuration_key', 'MODULE_DEFAULT_ADDSHOPPERS');
      $Qdel->execute();
