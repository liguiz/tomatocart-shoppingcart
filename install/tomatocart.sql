...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Search Results', 'MAX_DISPLAY_SEARCH_RESULTS', '20', 'Amount of products to list', '3', '2', now());
...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('Default Template', 'DEFAULT_TEMPLATE', 'glass_gray', 'TomatoCart Glass Gray', '6', '0', now());
...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Use MIME HTML When Sending Emails', 'EMAIL_USE_HTML', '-1', 'Send e-mails in HTML format', '12', '7', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Verify E-Mail Addresses Through DNS', 'ENTRY_EMAIL_ADDRESS_CHECK', '-1', 'Verify e-mail address through a DNS server', '12', '8', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) VALUES ('Send E-Mails', 'SEND_EMAILS', '1', 'Send out e-mails', '12', '9', 'osc_cfg_use_get_boolean_value', 'osc_cfg_set_boolean_value(array(1, -1))', now());
...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('GZIP', 'CFG_APP_GZIP', '', 'The program location to gzip.', '18', '1', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) VALUES ('GUNZIP', 'CFG_APP_GUNZIP', '', 'The program location to gunzip.', '18', '2', now());
...
INSERT INTO toc_templates VALUES (1, 'TomatoCart Glass Gray', 'glass_gray', 'TomatoCart', 'http://www.tomatocart.com', 'XHTML 1.0 Transitional', 1, 'Screen');

INSERT INTO toc_templates_boxes VALUES (1,'Best Sellers','best_sellers','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (2,'Categories','categories','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (3,'Currencies','currencies','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (4,'Information','information','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (5,'Manufacturer Info','manufacturer_info','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (6,'Manufacturers','manufacturers','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (7,'Order History','order_history','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (8,'Product Notifications','product_notifications','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (9,'Reviews','reviews','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (10,'Specials','specials','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (11,'Tell a Friend','tell_a_friend','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (12,'What\'s New','whats_new','osCommerce','http://www.oscommerce.com','boxes');
INSERT INTO toc_templates_boxes VALUES (13,'New Products','new_products','osCommerce','http://www.oscommerce.com','content');
INSERT INTO toc_templates_boxes VALUES (14,'Upcoming Products','upcoming_products','osCommerce','http://www.oscommerce.com','content');
INSERT INTO toc_templates_boxes VALUES (15,'Recently Visited','recently_visited','osCommerce','http://www.oscommerce.com','content');
INSERT INTO toc_templates_boxes VALUES (16,'Also Purchased Products','also_purchased_products','osCommerce','http://www.oscommerce.com','content');
INSERT INTO toc_templates_boxes VALUES (17,'Cross Sell Products','xsell_products','TomatoCart','http://www.tomatocart.com','content');
...
INSERT INTO toc_templates_boxes_to_pages VALUES (3,12,1,'*','right',100,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (4,4,1,'*','left',300,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (5,5,1,'products/info','right',200,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (6,7,1,'*','right',300,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (7,1,1,'*','right',400,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (8,8,1,'products/info','right',500,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (9,11,1,'products/info','right',600,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (10,10,1,'*','right',700,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (11,9,1,'*','right',800,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (12,3,1,'*','right',1000,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (13,13,1,'index/category_listing','after',400,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (14,13,1,'index/index','after',400,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (15,14,1,'index/index','after',450,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (16,15,1,'*','after',500,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (17,16,1,'products/info','after',100,0);
INSERT INTO toc_templates_boxes_to_pages VALUES (18,17,1,'products/info','after',200,0);
...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Random Review Selection', 'BOX_REVIEWS_RANDOM_SELECT', '10', 'Select a random review from this amount of the newest reviews available', '6', '0', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Cache Contents', 'BOX_REVIEWS_CACHE', '1', 'Number of minutes to keep the contents cached (0 = no cache)', '6', '0', now());
...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Cache Contents', 'BOX_SPECIALS_CACHE', '1', 'Number of minutes to keep the contents cached (0 = no cache)', '6', '0', now());
...
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Cache Contents', 'BOX_WHATS_NEW_CACHE', '1', 'Number of minutes to keep the contents cached (0 = no cache)', '6', '0', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Maximum Entries To Display', 'MODULE_CONTENT_NEW_PRODUCTS_MAX_DISPLAY', '9', 'Maximum number of new products to display', '6', '0', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Cache Contents', 'MODULE_CONTENT_NEW_PRODUCTS_CACHE', '60', 'Number of minutes to keep the contents cached (0 = no cache)', '6', '0', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Minimum Entries To Display', 'MODULE_CONTENT_ALSO_PURCHASED_MIN_DISPLAY', '1', 'Minimum number of also purchased products to display', '6', '0', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Maximum Entries To Display', 'MODULE_CONTENT_ALSO_PURCHASED_MAX_DISPLAY', '6', 'Maximum number of also purchased products to display', '6', '0', now());
INSERT INTO toc_configuration (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Cache Contents', 'MODULE_CONTENT_ALSO_PURCHASED_PRODUCTS_CACHE', '60', 'Number of minutes to keep the contents cached (0 = no cache)', '6', '0', now());
